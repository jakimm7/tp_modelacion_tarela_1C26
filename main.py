...
def main():
    ...
    r_orion, v_orion, r_luna_fix, mejor_ang, T_FLY = calculo_posicion_velocidad_orion(r0_orion, v0_orion)
    ...
    imprimir_resultados("2 y 3", "Trayectoria Orion - Free Return (Problema 3 Cuerpos)", [
        ("seccion", "Shooting Method"),
        ("dato", "Angulo basal de v0", f"{ang_basal:.4f}", "grados"),
        ("dato", "Correccion optima dt", f"{mejor_ang:.4f}", "grados"),
        ("dato", "Angulo final de v0", f"{ang_basal + mejor_ang:.4f}", "grados"),
        ("dato", "Modulo de v0 aplicado", f"{np.linalg.norm(v0_orion):.6f}", "km/s"),
 
        ("seccion", "Trayectoria resultante"),
        ...
        ("texto", ""),
        ("texto", "Orion completa el ocho espacial y regresa: free-return exitoso"),
    ])
    ...
    r_ny5, v_ny5, E_ny5 = metodo_alternativo_nynstrom(r_eu5, v_eu5, r_rk5, v_rk5, E0, t5, N5, h5)
